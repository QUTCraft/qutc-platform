...
import { Document, Files, Notebook, Reading } from '@element-plus/icons-vue'
    ...
    <template v-if="data">
      <section class="portal-hero">
        <div class="hero-copy">
          ...
          <div class="hero-actions">
            ...
            <RouterLink to="/knowledge">
              <el-button size="large" round>进入知识库</el-button>
            </RouterLink>
          </div>
        </div>
        ...
        <aside class="hero-status" aria-label="公开服务状态">
          ...
          <dl v-if="data.serverStatus.enabled">
            <div><dt>版本</dt><dd>{{ data.serverStatus.version }}</dd></div>
            <div><dt>在线玩家</dt><dd>{{ data.serverStatus.online_players }} / {{ data.serverStatus.max_players }}</dd></div>
            <div><dt>最近同步</dt><dd>{{ formatDate(data.serverStatus.updated_at) }}</dd></div>
          </dl>
          <el-button
      ...
      <section class="portal-section">
        ...
        <div class="news-layout">
          ...
          <div class="news-list">
            <article v-for="post in data.posts.slice(1)" :key="post.id">
              <div>
      ...
      <section class="portal-section">
        ...
        <div class="card-grid">
          <ContentCard
            ...
            :tags="project.tags"
            :meta="`更新于 ${formatDate(project.updated_at)}`"
          />
        </div>
      </section>
      ...
      <section class="split-section">
        <div class="surface-panel">
          ...
          <div class="compact-list">
            <RouterLink v-for="resource in data.resources" :key="resource.id" to="/resources">
        ...
        <div class="surface-panel">
          ...
          <div class="compact-list">
            <RouterLink v-for="article in data.knowledge" :key="article.id" to="/knowledge">
