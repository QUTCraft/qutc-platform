...
export const adminApi = {
  ...
  getContent: (params: PageQuery & { status?: AdminContent['status'] | '' } = {}) => getPage<AdminContent>(withQuery(`${adminBase}/content`, params)),
  ...
  updateContentVisibility: (id: string, payload: { is_public: boolean }) => patch<AdminContent>(`${adminBase}/content/${id}/visibility`, payload),
  ...
  deleteKnowledgeDirectory: (id: string) => del<{ removed: boolean; id: string }>(`${adminBase}/knowledge/directories/${id}`),
  ...
  deleteUser: (id: string) => del<{ removed: boolean; id: string; user_id: string }>(`${adminBase}/users/${id}`),
  ...
  deleteActivityPlan: (id: string) => del<{ removed: boolean; id: string }>(`${adminBase}/ai/activity-plans/${id}`),
  ...
  deleteProject: (id: string) => del<{ removed: boolean; id: string }>(`${adminBase}/projects/${id}`),
